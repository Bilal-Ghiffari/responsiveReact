                    ...
                    Array(5).fill().map((_, index )=> {
                        return (
                            <div className="px-2 relative card group" key={index}>
                                <div
                                className="rouded-xl item bg-gray-300 animate-pulse" style={{width: 106, height: 106}}
                                >
                                </div>
                            </div>
                        )
                    ...
                    return (
                        <div className="px-3 flex-none" style={{width: 320}} key={index}>
                            ...
                            <div className="rounded-xl overflow-hidden card-shadow w-full h-36">
                                <div className="rouded-lg item bg-gray-300 animate-pulse overflow-hidden" style={{width: 287, height: 150}}></div>
                            </div>
