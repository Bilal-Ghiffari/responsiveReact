...
export default function Justarrived() {
    const {data, run, error, isLoading} = useAsnyc();
    ...
    return (
        ...
        <div className="container mx-auto mb-4">
            ...
            <h3 className="text-2xl text-yellow-900 capitalize font-semibold">
            ...
            ) : <Carousel refContainer={refContainer}>
            {
                ...
                return (
                    ...
                    <div
                        ...
                        style={{ width: 287, height: 386 }}
                    >
                        <div className="absolute opacity-0 group-hover:opacity-100 transition duration-200 flex items-center justify-center w-full h-full bg-yellow-800 bg-opacity-35">
                        <div className="bg-yellow-600 text-black rounded-full w-16 h-16 flex items-center justify-center">
                            {/* <h2 className="text-white text-lg font-semibold ">Minimalism</h2> */}
                            <svg
                    ...
                    <h5 className="text-lg font-semibold mt-4 text-yellow-800">{item.title}</h5>
                    <span className="text-yellow-700">{item.price.currency()}</span>
                    <Link
