    ...
    <header className={[position, "w-full z-20 px-4"].join(" ")}>
        <div className="container mx-auto py-5">
            ...
            <div className="w-auto md:py-5">
                <ul
                className="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center md:mb-11"
                id="menu"
                >
                <li className="mx-3 py-6 md:py-0">
                    <Link to="/showcase" className={[theme === "white" ?  "text-black md:text-white hover:underline" : "text-white md:text-black hover:underline"].join(" ")}>
                        Showcase
                    </Link>
                </li>
                <li className="mx-3 py-6 md:py-0">
                    <Link to="/Catalog" className={[theme === "white" ?  "text-black md:text-white hover:underline" : "text-white md:text-black hover:underline"].join(" ")}>
                        Catalog
                    </Link>
                </li>
                <li className="mx-3 py-6 md:py-0">
                    <Link to="/Delivery" className={[theme === "white" ?  "text-black md:text-white hover:underline" : "text-white md:text-black hover:underline"].join(" ")}>
                        Delivery
                    </Link>
                </li>
                <li className="mx-3 py-6 md:py-0">
                    <Link to="/Rewards" className={[theme === "white" ?  "text-black md:text-white hover:underline" : "text-white md:text-black hover:underline"].join(" ")}>
                        Rewards
                    </Link>
                </li>
                </ul>
            ...
            <div className="w-auto">
                <ul className="items-center flex md:mb-11">
